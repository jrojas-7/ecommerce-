    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link {{ setActive('products.index') }}" href="{{ route('products.index') }}">Productos</a></li>
                ...
                @guest
                    ...
                    <li class="nav-item"><a class="nav-link {{ setActive('login') }}" href="{{ route('login') }}">Logearse</a></li>
                @else
